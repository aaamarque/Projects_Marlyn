...
module bnn_bnn_Pipeline_VITIS_LOOP_177_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [3:0] layer3_output_address0;
output   layer3_output_ce0;
input  [7:0] layer3_output_q0;
...
reg   [7:0] layer3_output_load_reg_146;
wire   [63:0] zext_ln177_fu_105_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [3:0] i_fu_50;
wire   [3:0] add_ln177_fu_99_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_i_3;
reg    layer3_output_ce0_local;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln177_fu_93_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln177_fu_93_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        layer3_output_ce0_local = 1'b1;
    end else begin
        layer3_output_ce0_local = 1'b0;
    end
end
...
assign add_ln177_fu_99_p2 = (ap_sig_allocacmp_i_3 + 4'd1);
...
assign icmp_ln177_fu_93_p2 = ((ap_sig_allocacmp_i_3 == 4'd10) ? 1'b1 : 1'b0);

assign layer3_output_address0 = zext_ln177_fu_105_p1;

assign layer3_output_ce0 = layer3_output_ce0_local;
...
assign m_axi_gmem_0_WDATA = $signed(layer3_output_load_reg_146);
...
assign zext_ln177_fu_105_p1 = ap_sig_allocacmp_i_3;

endmodule //bnn_bnn_Pipeline_VITIS_LOOP_177_1
