...
entity bnn_bnn_Pipeline_VITIS_LOOP_177_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bnn_bnn_Pipeline_VITIS_LOOP_177_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln177_fu_93_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal layer3_output_load_reg_146 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln177_fu_105_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal i_fu_50 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal add_ln177_fu_99_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_3 : STD_LOGIC_VECTOR (3 downto 0);
    signal layer3_output_ce0_local : STD_LOGIC;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln177_fu_93_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_50 <= add_ln177_fu_99_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                layer3_output_load_reg_146 <= layer3_output_q0;
            end if;
        end if;
    end process;
    ...
    add_ln177_fu_99_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln177_fu_93_p2)
    begin
        if (((icmp_ln177_fu_93_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln177_fu_93_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv4_A) else "0";
    layer3_output_address0 <= zext_ln177_fu_105_p1(4 - 1 downto 0);
    layer3_output_ce0 <= layer3_output_ce0_local;

    layer3_output_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            layer3_output_ce0_local <= ap_const_logic_1;
        else 
            layer3_output_ce0_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    m_axi_gmem_0_RREADY <= ap_const_logic_0;
        m_axi_gmem_0_WDATA <= std_logic_vector(IEEE.numeric_std.resize(signed(layer3_output_load_reg_146),32));
    ...
    zext_ln177_fu_105_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_3),64));
end behav;
