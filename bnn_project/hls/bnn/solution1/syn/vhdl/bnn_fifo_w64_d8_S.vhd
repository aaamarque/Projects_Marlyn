...
architecture rtl of bnn_fifo_w64_d8_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component bnn_fifo_w64_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_bnn_fifo_w64_d8_S_ShiftReg : bnn_fifo_w64_d8_S_ShiftReg
    generic map (
...
entity bnn_fifo_w64_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end bnn_fifo_w64_d8_S_ShiftReg;

architecture rtl of bnn_fifo_w64_d8_S_ShiftReg is
