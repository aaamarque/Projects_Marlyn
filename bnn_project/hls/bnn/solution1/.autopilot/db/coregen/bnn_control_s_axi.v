...
localparam
    ...
    ADDR_YS_DATA_0   = 6'h1c,
    ADDR_YS_DATA_1   = 6'h20,
    ADDR_YS_CTRL     = 6'h24,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_YS_DATA_0: begin
                    rdata <= int_ys[31:0];
                end
                ADDR_YS_DATA_1: begin
                    rdata <= int_ys[63:32];
                end
            endcase
        end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_YS_DATA_0)
            int_ys[31:0] <= (WDATA[31:0] & wmask) | (int_ys[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_YS_DATA_1)
            int_ys[63:32] <= (WDATA[31:0] & wmask) | (int_ys[63:32] & ~wmask);
    end
end
