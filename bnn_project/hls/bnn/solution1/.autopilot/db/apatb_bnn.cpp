...
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.bnn.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.bnn.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.bnn.autotvout_gmem.dat"
...
void apatb_bnn_hw(void* __xlx_apatb_param_IN_r, void* __xlx_apatb_param_ys)
{
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_ys;
  ...
  port1.param = &__xlx_offset_byte_param_ys;
  ...
  port2.param = { __xlx_apatb_param_IN_r, __xlx_apatb_param_ys };
  port2.mname = { "IN_r", "ys" };
  port2.nbytes = { 100, 40 };
  ...
  __xlx_offset_byte_param_IN_r = port2.offset[0]*4;
  __xlx_offset_byte_param_ys = port2.offset[1]*4;
