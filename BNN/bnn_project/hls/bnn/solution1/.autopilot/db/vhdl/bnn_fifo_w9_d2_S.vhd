...
architecture rtl of bnn_fifo_w9_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component bnn_fifo_w9_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 9;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_bnn_fifo_w9_d2_S_ShiftReg : bnn_fifo_w9_d2_S_ShiftReg
    generic map (
...
entity bnn_fifo_w9_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 9;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end bnn_fifo_w9_d2_S_ShiftReg;

architecture rtl of bnn_fifo_w9_d2_S_ShiftReg is
