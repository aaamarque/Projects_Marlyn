...
set C_modelArgMapList {[ 
	{ "Name" : "ys", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "IN_r","offset": { "type": "dynamic","port_name": "IN_r","bundle": "control"},"direction": "READONLY"},{"cName": "ys","offset": { "type": "dynamic","port_name": "ys","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ ys_dout sc_in sc_lv 64 signal 0 } 
	{ ys_empty_n sc_in sc_logic 1 signal 0 } 
	{ ys_read sc_out sc_logic 1 signal 0 } 
	{ ys_num_data_valid sc_in sc_lv 4 signal 0 } 
	{ ys_fifo_cap sc_in sc_lv 4 signal 0 } 
	...
	{ m_axi_gmem_0_RFIFONUM sc_in sc_lv 10 signal 1 } 
	...
	{ p_read3 sc_in sc_lv 9 signal 5 } 
	{ p_read4 sc_in sc_lv 9 signal 6 } 
	{ p_read5 sc_in sc_lv 9 signal 7 } 
	{ p_read6 sc_in sc_lv 9 signal 8 } 
	{ p_read7 sc_in sc_lv 9 signal 9 } 
	{ p_read8 sc_in sc_lv 9 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ys_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "ys", "role": "dout" }} , 
 	{ "name": "ys_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ys", "role": "empty_n" }} , 
 	{ "name": "ys_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ys", "role": "read" }} , 
 	{ "name": "ys_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "ys", "role": "num_data_valid" }} , 
 	{ "name": "ys_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "ys", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ys", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	ys { ap_fifo {  { ys_dout fifo_data_in 0 64 }  { ys_empty_n fifo_status 0 1 }  { ys_read fifo_port_we 1 1 }  { ys_num_data_valid fifo_status_num_data_valid 0 4 }  { ys_fifo_cap fifo_update 0 4 } } }
